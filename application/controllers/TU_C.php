...
class TU_C extends CI_Controller {
	...
	public function index(){
		$data = array(
			...
			'title_level2'	=>'',
			'surat'		=>$this->model->get_srt_by_ksb('TU')->result(),
			
			'konten'	=>'direktori/TU/surat',
			);
	...
	public function print_srt($id){
		...
		$this->load->view('direktori/TU/surat_print',$data);
	}
}
