...
class lalin_C extends CI_Controller {
	...
	public function index(){
		$data = array(
			...
			'title_level2'	=>'',
			'surat'			=>$this->model->get_srt_by_ksb('lalin')->result(),
			'konten'		=>'direktori/lalin/surat',
			);
	...
	public function edit($id)
 	{
		...
		$data = array(
			...
			'konten'	=>'direktori/lalin/edit_srt',
		);
		$this->load->view('direktori/template',$data);
 	}
	...
	public function print_srt($id){
		...
		$this->load->view('direktori/lalin/surat_print',$data);
	}
