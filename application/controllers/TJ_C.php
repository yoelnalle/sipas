...
class TJ_C extends CI_Controller {
	...
	public function index(){
		$data = array(
			...
			'title_level2'	=>'',
			'surat'		=>$this->model->get_srt_by_ksb('TJ')->result(),
			
			'konten'	=>'direktori/TJ/surat',
			);
	...
	public function print_srt($id){
		...
		$this->load->view('direktori/TJ/surat_print',$data);
	}
}
