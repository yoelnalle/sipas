...
<table id="table" class="table table-bordered table-striped text-center">
	...
	<TBODY>
		...
		<TR>
			...
			<td>
			<small>	<?php $date=date_create($key->tgl);echo date_format($date,'d F Y'); ?>
			<?= $key->pukul?></small>
			</td>
			<td></td>
			<td><?= $key->asal_srt?></td>
			...
			<td><?= $key->catatan1 ?></td>
             ...
             <?= $key->ukuran?> KB
              <a href="<?php echo base_url('assets/uploads/'.$key->foto)?>" class="btn btn-default btn-xs pull-right"><i class="fa fa-cloud-download"></i></a>
             </span>
         	</small>
			</td>
			<td>
				<a href="<?php echo base_url('index.php/sarpras_C/edit/'.$key->id_srt)?>" class="btn btn-success" data-toggle="tooltip" data-original-title="edit">
