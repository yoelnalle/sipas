<form action="<?php echo site_url('/sarpras_C/update_srt/'.$surat->id_srt)?>"  enctype="multipart/form-data" method="post">
...
<div class="col-md-14">
	...
	<div class="col-md-8">
		...
		<a href="<?php echo base_url('index.php/sarpras_C/print_srt/'.$surat->id_srt)?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print Disposisi</a>
