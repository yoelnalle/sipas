<form action="<?php echo site_url('/administrator/update/'.$surat->id_surat)?>"  enctype="multipart/form-data" method="post">
<input type="hidden" name="id_surat" value="<?= $surat->id_surat ?>" required>
	
	<div class="form-group">
		<label> Tanggal</label>
		<input type="date" name="tanggal"  class="form-control" placeholder="Tanggal" 
		required value="<?= $surat->tanggal ?>">
	</div>
	<div class="form-group">
	...
	<div class="form-group">
		...
		<a href="<?php echo base_url('index.php/administrator/srt_keluar/')?>" class="btn btn-danger">Cancel</a>
	</div>
</form>
