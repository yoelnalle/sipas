<form action="<?php echo base_url()?>index.php/administrator/finish" enctype="multipart/form-data" method="post">
	...
	<div class="form-group">
		...
		<a href="<?php echo base_url('index.php/administrator/srt_keluar/')?>" class="btn btn-danger">Kembali</a>
	</div>
</form>
