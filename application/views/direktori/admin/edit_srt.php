<form action="<?php echo site_url('/admin_C/update_srt/'.$surat->id_srt)?>"  enctype="multipart/form-data" method="post">
<input type="hidden" name="id_srt" value="<?= $surat->id_srt ?>" required>
	...
	<?php endif;?>
		...
		<a href="<?php echo base_url('index.php/admin_C/surat')?>" class="btn btn-danger">Cancel</a>
		<a href="<?php echo base_url('index.php/admin_C/print_srt/'.$surat->id_srt)?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print Disposisi</a>	
		</div>
