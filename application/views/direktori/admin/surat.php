<div class="row">
	<div class="col-xs-12">
		...
		<div class="box box-default">
			<div class="box-body">
				<a class="btn btn-primary" href="<?php echo base_url('index.php/admin_C/tambah/add_srt')?>">
					Tambah Data
				</a>
			</div>
		</div>
	...
	<table id="table" class="table table-bordered table-striped text-center">
		...
		<TBODY>
			...
			<TR>
				...
				<td>
					<a href="<?php echo base_url('index.php/admin_C/edit/'.$key->id_srt)?>"
					...
					<a onclick='return confirm("Yakin ingin menghapus data ini?")'
						href="<?php echo base_url('index.php/admin_C/hapus_srt/'.$key->id_srt)?>"
