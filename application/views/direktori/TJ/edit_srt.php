<form action="<?php echo site_url('/TJ_C/update_srt/'.$surat->id_srt)?>"  enctype="multipart/form-data" method="post">
...
<div class="col-md-14">
	...
	<div class="col-md-8">
		...
		<a href="<?php echo base_url('index.php/TJ_C')?>" class="btn btn-danger">Cancel</a>	
		<a href="<?php echo base_url('index.php/TJ_C/print_srt/'.$surat->id_srt)?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print Disposisi</a>
