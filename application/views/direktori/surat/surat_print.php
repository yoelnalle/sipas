						...
						<div class="col-xs-6">
							<?php foreach($kasubag as $key): ?>
								...
								<div class="form-check form-check-inline">
									<input <?= $select ?> name="" class="minimal" type="checkbox" id="<?= $key->id_ksb ?>" value=" ">
									<label class="minimal" for="<?= $key->id_ksb ?>"><?= $key->nama_lengkap ?></label>
								</div>
							<?php endforeach ?>
								<div class="form-check form-check-inline">
									<input class="minimal" type="checkbox" id="5"value="PEJABAT PEMBUAT KOMITMEN RUTIN">
									<label class="minimal" for="5"> PEJABAT PEMBUAT KOMITMEN RUTIN</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="minimal" type="checkbox" id="6" value="PEJABAT PEMBUAT KOMITMEN MODAL 1">
									<label class="minimal" for="6"> PEJABAT PEMBUAT KOMITMEN MODAL 1</label>
								</div>
							</div>
							<div class="col-xs-6">
								<div class="form-check form-check-inline">
