<form action="<?php echo base_url()?>index.php/administrator/simpan" enctype="multipart/form-data" method="post">
	...
	<div class="form-group">
		<label>Diteruskan Kepada Yth :</label>
		<select name="kasubag" class="form-control" required>
			<option value="">-pilih-</option>
			<?php foreach ($kasubag as $key){ 
	    echo '<option value="'.$key->id_ksb.'">'.$key->nama_lengkap.'</option>';
	    }
	    ?>
		</select>
	</div>
	...
	<div class="form-group">
		...
		<a href="<?php echo base_url('index.php/administrator')?>" class="btn btn-danger">Kembali</a>
	</div>
</form>
