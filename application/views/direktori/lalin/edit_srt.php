<form action="<?php echo site_url('/lalin_C/update_srt/'.$surat->id_srt)?>" enctype="multipart/form-data" method="post">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="form-group">
					...
					<input type="text" name="Nmr_Agenda" class="form-control" placeholder="Nomor Agenda" disabled
						value="<?=  $surat->Nmr_Agenda ?>">
				</div>
				<div class="form-group">
					<label> Tanggal:</label>
					<input type="text" name="tgl" class="form-control" placeholder="Tanggal Terima" disabled
						value="<?= $surat->tgl ?>">
				</div>
				<div class="form-group">
					<label> Pukul:</label>
	...
	<div class="row mb-2">
		<div class="col-md-3">
			<h3>
				<p class="text-muted">File sebelumnya</p>
			</h3>
	...
	<div class="form-group">
		...
		<textarea type="text" name="Catatan" disabled class="form-control"
			placeholder="Catatan"><?= $surat->catatan ?></textarea>
	</div>
	<div class="form-group">
		<label> Catatan: </label>
	...
	<div class="form-group">
		...
		<a href="<?php echo base_url('index.php/lalin_C')?>" class="btn btn-danger">Cancel</a>
		<a href="<?php echo base_url('index.php/lalin_C/print_srt/'.$surat->id_srt)?>" target="_blank" class="btn btn-default"><i class="fa fa-print"></i> Print Disposisi</a>
	</div>
